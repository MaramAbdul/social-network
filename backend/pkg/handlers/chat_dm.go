...
// GET /api/dm/history?userId=<peer>&limit=50
func (h *DMHandler) History(w http.ResponseWriter, r *http.Request) {
	...
	if peer == "" { Err(w, 400, "userId required"); return }
...
LIMIT ?`, u.ID, peer, peer, u.ID, limit)
